...
function Homepage() {
    const renderData = (
        <div>
            {/* Banner Image */}
            <img src={allImages.imgUrl} className="w-full object-fill h-[43.75rem] overflow-hidden" />
                ...
                <div className="container px-5 py-16 mx-auto">
                    ...
                    <div className="flex flex-wrap -m-4">
                        ...
                        <div className="p-4 md:w-1/3">
                            <div className="flex rounded-lg h-full bg-[#1B3950] text-white p-8 flex-col">
                        ...
                        <div className="p-4 md:w-1/3">
                            <div className="flex rounded-lg h-full bg-[#1B3950] p-8 flex-col">
                                <div className="flex items-center mb-3">
                                    <div className="w-8 h-8 mr-3 inline-flex items-center justify-center rounded-full bg-indigo-500 text-white flex-shrink-0">
